...
| 4 | ICE | 2019 | underserved markets | tier_1_conservative | excluded_non_treatment | Underserved markets refers to issuer acquisition/growth rationale, not external financial-access expansion. | including leveraging our existing strengths to enter new markets in our industry or related industries, expanding our products and services, diversifying our business, addressing underserved markets, advancing our techno |
...
| 23 | OPRT | 2025 | underserved borrowers | tier_1_conservative | excluded_non_treatment | Excerpt is competitor/risk discussion about firms focused on underserved borrowers, not issuer access expansion. | onsumers who do not have access to mainstream credit, including online marketplace lenders, point-of-sale lending, payday lenders, and auto title lenders and pawn shops focused on underserved borrowers. We may compete wi |
| 24 | LSAK | 2016 | unbanked | tier_1_conservative | excluded_non_treatment | Risk discussion describes competitor banks targeting the unbanked, not issuer access expansion. | segment, which could limit growth in our transaction-based activities segment. Certain South African banks have also developed their own low-cost banking products targeted at the unbanked and under-banked market segment. |
...
- ICE-style `underserved markets` language is often issuer expansion into markets rather than external financial-access expansion.
